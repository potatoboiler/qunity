    ...
    case context_check ([]) t e of {
     Prelude.Just d ->
      case pure_type_check ([]) d e' of {
       ...
       Prelude.Nothing ->
        case mixed_type_check1 (restriction d (free_vars e')) e' of {
...
mixed_type_check0 :: Context -> Expr -> Prelude.Maybe Type
mixed_type_check0 =
  mixed_type_check pure_type_check prog_type_check
